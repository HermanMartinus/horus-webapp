(function () {
  document.getElementById('packingKey').value = getSavedValue('packingKey')
  ...
  if (document.body.classList.contains('has-animations')) {
    ...
    sr.reveal('.hero-title, .hero-paragraph, .newsletter-header, .newsletter-form, .password', {
      duration: 1000,
      distance: '40px',
...
function gennygen () {
  var packingKey = document.getElementById('packingKey').value.toLowerCase()
  var serviceName = document.getElementById('serviceName').value.toLowerCase()
  thingthang = cerryroo(packingKey, serviceName)
}

function cerryroo (seed, service) {
